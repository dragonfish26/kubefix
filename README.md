...
## To view modifications before/after on test

One can view the before and after of the modified diagrams of the test manifests (in the examples dir), generated by Kubediagrams as below :

    ./generate.sh -> and view diagrams.md
